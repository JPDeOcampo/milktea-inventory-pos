...
Public Class MDIParent1
    ...
    Private Sub POSPressF2_Click(sender As Object, e As EventArgs) Handles POSPressF2.Click
        POS.Show()
        POS.MdiParent = Me
    End Sub

    Private Sub InventoryMngmnt2_Click(sender As Object, e As EventArgs) Handles InventoryMngmnt2.Click
        InventoryManagement.Show()
        InventoryManagement.MdiParent = Me
    End Sub
    ...
    Private Sub UserAccountToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles UserAccountToolStripMenuItem.Click
        User_Account.Show()
        User_Account.MdiParent = Me
    End Sub

    Private Sub ReportPressF4_Click(sender As Object, e As EventArgs) Handles ReportPressF4.Click
        TestReport.Show()
